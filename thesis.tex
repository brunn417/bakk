...
Wie in \ref{chap:rest} bereits erläutert, müssen fünf REST-Constraints gesättigt werden, damit die Schnittstelle den von Roy Fielding definierten Anforderungen gerecht wird.
