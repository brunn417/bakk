...
Jede:r Benutzer:in wird durch eine eindeutige ID identifiziert. 
...
Substrings
\footnote{
	Strings ist ein Datentyp der jede Art von Zeichenreihen beschreibt. Substrings sind echte Teilmengen dieser Strings.
}
...
Basierend auf der ermittelten ID soll ein weiterer Endpunkt eingerichtet werden, der alle Projekte zurückgibt, die dem:der Benutzer:in mit dieser ID zugeordnet sind.
