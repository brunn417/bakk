...
Viele Websites ermöglichen zwar den Drittzugriff auf ihre Daten durch Web-APIs, jedoch erfordert die manuelle Kodierung von URLs – inklusive arbiträrer Endpunkte, Parameter, Authentifizierungsverfahren und Pagination – ein tiefgehendes Verständnis und erheblichen Arbeitsaufwand
\cite{Standardizing_APIs, Investigation_Web-APIs}. 
Trotz oft ähnlichem Informationstypen, besitzt eine Vielzahl an Web-APIs ihr eigenes, spezifisches Datenmodell, welche auf unterschiedliche Weise Methoden und Eigenschaften zur Verfügung stellt\cite{Standardizing_APIs}.
Um sich Zugang zu diesen unterschiedlichen Systemen zu ermöglichen, ist das notwendig, sich mit ihnen im Voraus vertraut zu machen. 
Jedoch wird dies durch die Vielfalt und oft inkonsistente Art der Dokumentation zusätzlich erschwert.
