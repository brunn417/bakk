...
In der Tabelle \ref{tab:REST-Constraints} werden die einzelnen Einschränkungen nocheinmal aufgelistet und kurz beschrieben.
...
\begin{table}[h]
	...
	\begin{tabular}{l|l}
		...
		\hline
		Zustandslos   & Jede Client-Anfrage beinhaltet alle notwendigen Informationen\\
		\hline 
