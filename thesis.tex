...
Eine Schwäche von REST ist das Over- und Underfetching
\footnote{
...
, welches GraphQL effektiv addressiert, indem es dem Client erlaubt, in nur einer Query genau zu spezifizieren, welche Daten benötigt werden. 
Dies führt zu einer signifikanten Reduktion der Antwortgrößen und somit zu den oben gelisteten Effizienzsteigerungen.
