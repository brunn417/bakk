...
\todo{not sure yet... vlt das was da philipp bereits verwendet übernehmen..wenn nicht noch ein modell zur veranschaulichung des authorisierungsprozesses}
...
Weiters leitet sich aus der REST-Einschränkung Uniform Interface ab, dass die Daten mittels den URIs nur wie der Name schon sagt, identifiziert werden sollen.
Deshalb werden Methoden benötigt, um mit den Daten nach belieben interagieren zu können.
Ein üblicher Ansatz ist das Verwenden der weit verbreiteten Hyper Text Transfer Protocol (HTTP) Methoden, welche auch für die Umsetzung dieser Schnittstelle in Kraft treten.
Da im ersten Prototyp der API nur Lese Operationen benötigt werden, wird die Implementierung mit der Methode \grqq GET \grqq auskommen.
In der folgenden Liste ist nur eine komplette REST GET Anfrage:
