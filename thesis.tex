...
\section{REST-APIs und REST-Constraints}
...
Die erste Einschränkung ist die Client-Server Abstraktion.
...
\textbf{{\large Ressourcen und Repräsentationen}}
...
\textbf{{\large Identifikation und Manipulation von Ressourcen}}
...
\textbf{{\large Selbstbeschreibende Nachrichten und HATEOAS}}
...
Zusammenfassend bildet die Uniform Interface Constraint die Grundlage für eine modulare, erweiterbare und wartbare REST-Architektur, die durch ihre strikte Trennung von Ressourcen und Repräsentationen sowie durch die Förderung von selbstbeschreibenden und hypermedia-gesteuerten Interaktionen gekennzeichnet ist.
