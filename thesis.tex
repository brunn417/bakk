...
Hier werden die oben besprochenen Endpunkte noch einmal aufgelistet.
...
\begin{lstlisting}[
	...
	function getProjectById($id) {
		return $Project; // retourniert eine JSON-Respräsentation des gesamten Projekts mit allen Feldnamen und dazugehörigen Eingabewerten
	}
\end{lstlisting}
