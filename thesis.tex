...
Ein spezifischer Fokus der Pulswerk GmbH liegt auf dem Baugewerbe, insbesondere in Bezug auf Herausforderungen des Klimaschutzes. Sie bietet verschiedene Webapplikationen an, die es ermöglichen, Gebäude nach verschiedenen Richtlinien wie klimaaktiv
\footnote{
	klimaaktiv ist ein österreichisches Programm zur Förderung klimafreundlichen Bauens, unterstützt durch das
