...
Die Pfade in einer URI sind typischerweise hierarchisch mit Subpfaden strukturiert, die durch Schrägstriche ("/") getrennt werden.
Des Weiteren ist es essentiell, dass in den Pfaden ausschließlich Nomen verwendet werden. 
Dies trägt nicht nur zur Klarheit bei, indem es sicherstellt, dass ausschließlich eindeutige und kontextspezifische Identifikatoren verwendet werden, sondern verhindert auch Missverständnisse, die durch den Einsatz von Verben oder adjektivischen Phrasen entstehen könnte.

Ein weiteres wichtiges Gestaltungsprinzip ist die Vermeidung von Pfadüberschneidungen. 
Kreuzen sich die Pfade verschiedener Endpunkte, kann dies zu einer unübersichtlichen und schwer wartbaren Struktur führen. 
