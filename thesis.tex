...
\section{Beschreibung des Unternehmens und der Kriterienkataloge}

Die Pulswerk GmbH, ein Tochterunternehmen des Österreichischen Ökologie-Instituts, hat sich seit ihrer Gründung 1985 als ein entscheidender Akteur im Bereich der ökologischen und nachhaltigen Entwicklung etabliert. Das Unternehmen tritt in einer breiten Palette von Sektoren als Initiator und Mitgestalter für zukunftsfähige Projekte auf und engagiert sich in diversen Netzwerken für die Planung und Realisierung nachhaltiger Initiativen.

Ein spezifischer Fokus der Pulswerk GmbH liegt auf dem Baugewerbe, insbesondere in Bezug auf Herausforderungen des Klimaschutzes. Sie bietet verschiedene Webapplikationen an, die es ermöglichen, Gebäude nach verschiedenen Kriterienkatalogen einfach und ohne bürokratischen Aufwand zu zertifizieren. Diese Kataloge, die als umfangreiche Formulare mit diversen Eingabeoptionen wie Textfeldern, Checkboxen, Radio-Buttons und Upload-Funktionen konzipiert sind, erlauben Nutzern, Daten einzutragen und abhängig von Plattform und spezifischem Kriterienkatalog Punkte zu erhalten.

Die von Nutzern eingegebenen Daten werden auf einem Server der Pulswerk GmbH gesichert und von deren Mitarbeiterinnen und Mitarbeitern auf Plausibilität hin überprüft.
...
Die Pulswerk GmbH, eine Tochterorganisation des Österreichischen Ökologie-Instituts, hat sich seit ihrer Gründung im Jahr 1985 zu einem Akteur in der ökologischen und nachhaltigen Entwicklung etabliert. 
Das Unternehmen agiert in einer Vielzahl von Sektoren als Initiatorin und Mitgestalterin nachhaltiger Projekte und ist in verschiedenen Netzwerken für die zukunftsorientierte Planung und Umsetzung nachhaltiger Programme aktiv. 

Die Pulswerk hat sich unter anderem auf den Bausektor und die dort vorhandenen Probleme bezüglich Klimaschutz spezialisiert.
So gibt es verschiedene Webapplikationen, die eine Gebäudezertifizierung nach unterschiedlichen Kriterienkatalogen
\footnote{
	Ein Kriterienkatalog ist ein vorkonfiguriertes Formular bestehend aus Eingabefelder in Form von Text- und Zahleingabe, Check-boxen, Radios und Uploads. 
	Benutzende befüllen diese Formulare und bekommen Plattform- und Kriterienkatalog-Abhängig Punkte.}
, ganz ohne bürokratischen Aufwand, ermöglichen. 
Diese detaillierten Eingaben werden auf einem Server gespeichert und von Mitarbeiter:innen der Pulswerk GmbH auf ihre Plausibilität überprüft. 

Diese Kriterienkataloge, die auf den verschiedenen Plattformen zum Einsatz kommen, unterscheiden sich zwischen den Webapplikationen, aber auch innerhalb der Plattformen gibt es für verschiedene Versionen, Gebäudetypen, etc. unterschiedliche Kriteriensets.  
