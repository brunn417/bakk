...
Wollen wir nun ein Query, um für eine Person mit ID 17 alle Posts und Kommentare abzurufen, genügt in GraphQL eine einzige Anfrage.

\begin{algorithm}
	query GetUserProfileWithPostsAndComments(\$userId: 17) {
		user(id: \%userId) {
			name
			email
			posts {
