...
Mehr als 10.000 Gebäude sind verteilt auf den Plattformen in Bearbeitung oder bereits abgeschlossen. 
Doch wegen dieser Verteilung können sie nicht gesammelt und "kontrolliert" abgerufen werden.
Das führte zu dem "Wunsch", dass eine Schnittstelle, die all diese Daten durchforsten und folglich ausspucken kann.
Diese Datensätze sind in Datenbanken auf einem Server gespeichert. 
