...
\footnote{Underfetching tritt auf, wenn eine Schnittstellenabfrage nicht alle erwünschten Daten in der Antwort enthält wohingegen beim Overfetching mehr als das Angeforderte retourniert wird.} 
...
So gibt es mehrere Webapplikationen, die eine Gebäudezertifizierung nach unterschiedlichen Kriterienkatalogen
\footnote{Ein Kriterienkatalog ist ein vorkonfiguriertes Formular mit Eingabefelder in Form von Text- und Zahleingabe, Checkboxen, Radios und Uploads. Der Benutzer befüllt diese Forumulare und bekommt Plattform und Krtierienkatalog abhängig bestimmte Punkte, je nachdem welche Vorgaben wie gut erfüllt werden.}
, ganz ohne bürokratischen Aufwand, ermöglichen. 
Diese detaillierten Eingaben werden auf einem Server gespeichert und von Mitarbeiter der Pulswerk GmbH auf ihre Plausibilität überprüft. 

Diese Kriterienkataloge, die auf den verscheidenen Plattformen zum Einsatz kommen, unterscheiden sich zwischen den Plattformen, aber auch oft innerhalb der Plattformen gibt es für verschiedene Versionen, Gebäudetypen etc verschiedene Kriteriensets.  
