...
\section{Theoretische Konzepte und Designprinzipien von Web-Schnittstellen}
...
Es exisitieren viele Ansätze, wie das Design einer API aussehen soll. 
Das Ziel ist immer dasselbe: Eine robuste und intuitive Schnittstelle.
Bricht man die wichtigsten Aspekte herunter, kommt man ungefähr zu folgenden Auflistung:
Schnittstellen sollen langlebig und mit möglich wenig Wartung laufen.
Sie sollen leiccht zu verwenden sein.
Es soll keine allzu ausführliche Dokumenation notwendig sein, da sich die Schnittstelle selbst beschreiben  soll.
Es soll im VOrrhiniien eine Anforderungsanalyse durchgeführt werden, um den tatsächlichen Ansprüchen gerecht zu werden.
