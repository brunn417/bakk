...
Der Großteil aller Web-APIs werden als REST-Schnittstellen deklariert, obwohl nur ein minimaler Anteil tatsächlich die REST-Prinzipien erfüllt \cite{Analysis-of-Rest}.
Zwar setzen die meisten dieser Schnittstellen einige der REST-Aspekte um, aber erfüllen beinahe nie den in Roy Fieldings Dissertation im Jahr 2000 definierten Architekturstil REST \cite{Analysis-of-Rest}.
Eine Softwarearchitektur sind die Komponenten eines Softwaresystems, die voneinander abhängig sind und miteinander kommunizieren müssen, um ein funktionsfähiges Programm am laufen zu lassen \cite.
Der Architekturstil gibt vor, welche architektonische Vorbedingungen erfüllt werden müssen, um ein System dem Stil zuordnen zu können.
