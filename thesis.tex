...
Web-Schnittstellen repräsentieren eine spezialisierte Kategorie von APIs, die spezifisch für die Kommunikation zwischen Web-Clients –- üblicherweise Web-Browsern –- und Web-Servern ausgelegt sind. Hierbei wird der Datenaustausch über das Hypertext Transfer Protocol (HTTP) oder dessen sichere Variante, HTTPS, abgewickelt, wobei eine große Bandbreite an Datenformaten wie HTML, XML oder JSON zum Einsatz kommen kann.
